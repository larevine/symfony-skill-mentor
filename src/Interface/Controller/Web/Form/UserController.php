...
namespace App\Interface\Controller\Web\Form;

use App\Application\Security\AppLoginAuthenticator;
use App\Application\Service\Management\UserManagementService;
use App\Application\Service\UserService;
use App\Domain\Entity\Skill;
use App\Domain\Entity\User;
use App\Interface\Controller\Form\Type\UserType;
...
class UserController extends AbstractController
{
    ...
    public function manageUserAction(Request $request, string $_route, ?User $user = null): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($is_route_update) {
                $user_id = $this->user_builder->updateUserWithRelatedEntities($user->getId(), $data);
            } else {
            ...
            return $this->redirectToRoute('app_interface_web_user_getusers');
        }
