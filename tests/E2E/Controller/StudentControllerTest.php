...
class StudentControllerTest extends AbstractApiTestCase
{
    ...
    public function testCreateStudent(): void
    {
        ...
        self::assertSame($student_data['first_name'], $data['first_name']);
        self::assertSame($student_data['last_name'], $data['last_name']);
        self::assertSame($new_email, $data['email']);
    }
    ...
    public function testGetStudent(): void
    {
        ...
        self::assertSame($student_data['first_name'], $data['first_name']);
        self::assertSame($student_data['last_name'], $data['last_name']);
        self::assertSame($student_data['email'], $data['email']);
    }
    ...
    public function testUpdateStudent(): void
    {
        ...
        $data = json_decode($this->client->getResponse()->getContent(), true);
        self::assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
        self::assertSame($updated_data['first_name'], $data['first_name']);
        self::assertSame($updated_data['last_name'], $data['last_name']);
        self::assertSame($updated_data['email'], $data['email']);
    }
